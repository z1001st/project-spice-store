...
const CategoryCassiaCinnamon = () => {
  ...
  useEffect(() => {
    dispatch(filterProductsByCategory("CategoryCassiaCinnamon"));
  }, [dispatch]);
...
export default CassiaCinnamonProduct
